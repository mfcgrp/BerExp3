...
function loadImages() {
  for(let x = 0; x < 9; x++) {
    loadImage(`Data-${x}.png`, (res) => {
      texturesArray.push(res)
    })
  }
}
...
//for(let x = 0; x < 9; x++) {
  //texturesArray.push(loadImage(`Data-${x}.png`))
//}

 // loading sphere texture images
 bergUV2 = loadImage("UA7/107992.png");
 ...
 //
  ...
  // bergUV9 = loadImage("Data-7.png");
  // bergUV10 = loadImage("Data-8.png");
}
function setup() {
